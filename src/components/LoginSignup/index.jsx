...
export default function LoginSignup({ pos }) {
  ...
  function changeFullName(val) {
    ...
    if (val.length > 20) {
      nameSpan.innerHTML =
        "Username should contain less than or equal to 20 characters";
    } else if (val.length < 5) {
      nameSpan.innerHTML =
        "Username should contain more than or equal to 5 characters";
      updateFullName(val);
    } else {
      nameSpan.innerHTML = "";
      updateFullName(val);
  ...
  function changePassword(val) {
    ...
    if (val.length > 20) {
      passwordSpan.innerHTML =
        "Password should contain less than or equal to 20 characters";
    } else if (val.length < 5) {
      passwordSpan.innerHTML =
        "Password should contain more than or equal to 5 characters";
      updatePassword(val);
    } else {
      passwordSpan.innerHTML = "";
      updatePassword(val);
    ...
    <div className={classes2.paper}>
      <section className="signup-form-section">
        ...
        <TextField
          ...
          variant="outlined"
          style={{ marginTop: "20px", minWidth: "80%" }}
          value={fullname}
        ...
        <TextField
          ...
          variant="outlined"
          style={{ marginTop: "25px", minWidth: "80%" }}
          value={email}
        ...
        <a href="#" onClick={signup} style={{ minWidth: "100%" }}>
          <Button
            variant="contained"
            color="primary"
            style={{
        ...
        <p>
          ...
          <a
            href="#"
            onClick={(e) => handleOpenCloseModals(e.target.innerText)}
          >
            Log In
          </a>
        </p>
        <a href="#">Sign Up with your Organization</a>
        <p style={{ marginTop: "30px", opacity: ".8" }}>
          I accept Coursera's Terms of Use and Privacy Notice. Having trouble
  ...
  const body2 = (
    <div className={classes2.paper}>
      <section className="signup-form-section">
        ...
        <a href="#" onClick={login} style={{ minWidth: "100%" }}>
          <Button
            variant="contained"
            color="primary"
            style={{
    ...
    <React.Fragment>
      {pos === "signup" ? (
        ...
        <Button
          ...
          endIcon={<ArrowDownwardIcon />}
          onClick={handleOpen}
          style={{ alignSelf: "start", marginTop: "20px" }}
        >
          <strong>Join for Free</strong>
        </Button>
      ) : (
